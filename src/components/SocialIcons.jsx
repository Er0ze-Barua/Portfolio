...
export function LeetCodeIcon({ size = 18, className = '' }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M13.483 0a1.374 1.374 0 0 0-.961.438L7.116 6.226l-3.854 4.126a5.266 5.266 0 0 0-1.209 2.104 5.35 5.35 0 0 0 .125 2.225l-2.818 4.352a1.374 1.374 0 0 0 1.117 2.071h4.764a1.374 1.374 0 0 0 1.205-.71l4.762-8.016 1.137 1.941L13.483 24h6.406a1.374 1.374 0 0 0 1.187-2.07l-3.7-6.3 1.637-2.691A4.765 4.765 0 0 0 24 8.476a4.765 4.765 0 0 0-4.765-4.765 4.765 4.765 0 0 0-1.476.251L15.525 0h-2.042z" />
    </svg>
  )
}
